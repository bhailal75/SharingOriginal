...
import com.lsfv.myliteraturesharing.Adapter.AllChapterListAdapter;
...
//    ListView listView;
    private AVLoadingIndicatorView pvChapter;
    private TextView tvLoading;
    private ArrayList<ChapterListBean> chapterList;
    private MediaPlayer player;
    private String s,type="a";
    private AllChapterListAdapter allChapterListAdapter;
    ...
    private int temppossong = 0;

    public AllChapterFragment(String bkname) {
        this.bkname = bkname;
